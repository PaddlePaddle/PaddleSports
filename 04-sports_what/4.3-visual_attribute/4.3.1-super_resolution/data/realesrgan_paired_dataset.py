...
from utils.img_util import img2tensor, imfrombytes

import paddle.io as io
from paddle.vision.transforms.functional import normalize

class RealESRGANPairedDataset(io.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mean is not None or self.std is not None:
            normalize(img_lq, self.mean, self.std)
            normalize(img_gt, self.mean, self.std)
