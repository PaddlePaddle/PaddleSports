...
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
      ...
      # input json
    parser.add_argument('--input_json', default='data/caption_datasets/dataset_coco.json', help='input json file to process into hdf5')
    ...
    parser.add_argument('--images_root', default='data/coco2014',
