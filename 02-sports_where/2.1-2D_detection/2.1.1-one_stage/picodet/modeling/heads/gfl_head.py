...
from modeling.layers import ConvNormLayer
from modeling.bbox_utils import distance2bbox, bbox2distance, batch_distance2bbox
...
class Integral(nn.Layer):
    ...
    Args:
        reg_max (int): The maximal value of the discrete set. Default: 16. You
            may want to reset it according to your new datasets or related
            settings.
    """
