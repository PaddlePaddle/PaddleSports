...
from modeling.initializer import normal_
from modeling.assigners.utils import generate_anchors_for_grid_cell
from modeling.bbox_utils import bbox_center, batch_distance2bbox, bbox2distance
from modeling.layers import ConvNormLayer,DeformableConvV2
from .simota_head import OTAVFLHead
from .gfl_head import Integral, GFLHead
from modeling.necks.lc_pan import DPModule
...
class PicoHead(OTAVFLHead):
    ...
    Args:
        ...
        loss_bbox (object): Instance of bbox losses.
