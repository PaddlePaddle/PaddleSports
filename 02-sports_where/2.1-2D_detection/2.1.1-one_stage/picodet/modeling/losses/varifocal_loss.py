...
def varifocal_loss(pred,
    ...
    Args:
        ...
        iou_weighted (bool, optional): Whether to weight the losses of the
...
class VarifocalLoss(nn.Layer):
    def __init__(self,
        ...
        Args:
            ...
            reduction (str, optional): The method used to reduce the losses into
                a scalar. Defaults to 'mean'. Options are "none", "mean" and
                "sum".
            loss_weight (float, optional): Weight of losses. Defaults to 1.0.
        """
    ...
    def forward(self, pred, target, weight=None, avg_factor=None):
        ...
        Args:
            ...
            weight (Tensor, optional): The weight of losses for each
                prediction. Defaults to None.
            avg_factor (int, optional): Average factor that is used to average
                the losses. Defaults to None.
        Returns:
            Tensor: The calculated losses
        """
