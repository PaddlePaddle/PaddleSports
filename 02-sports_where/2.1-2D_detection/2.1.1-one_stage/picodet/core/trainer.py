...
class Trainer(object):
    def __init__(self, cfg, mode='train'):
        ...
        # build model
        assert cfg['architecture'] in ['PicoDet'],'architecture {} not available!'.format(cfg['architecture'])
            ...
            if validate and is_snapshot:
                if not hasattr(self, '_eval_loader'):
                    ...
                    loader_ = EvalReader(
                        ...
                        batch_transforms=self.cfg['EvalReader']['batch_transforms'],
                        batch_size=self.cfg['EvalReader']['batch_size'],
                        shuffle=self.cfg['EvalReader']['shuffle']
                    )
