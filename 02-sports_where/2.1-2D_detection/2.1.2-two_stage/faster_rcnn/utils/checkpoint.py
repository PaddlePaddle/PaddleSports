...
def match_state_dict(model_state_dict, weight_state_dict):
    ...
    subclass of the names in models`, if the prefix 'backbones.' in pretrained weight
    ...
    'backbones.res2.res2a.branch2a.conv.weight' and the pretrained weight as
    ...
    def match(a, b):
        if b.startswith('backbones.res5'):
            # In Faster RCNN, res5 pretrained weights have prefix of backbones,
