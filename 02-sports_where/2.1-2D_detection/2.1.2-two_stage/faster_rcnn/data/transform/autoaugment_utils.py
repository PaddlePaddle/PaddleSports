...
def equalize(image):
    ...
    def scale_channel(im, c):
        """Scale the datasets in the channel to implement equalize."""
...
def build_and_apply_nas_policy(policies, image, bboxes, augmentation_hparams):
    ...
    Returns:
        A version of image that now has datasets augmentation applied to it based on
...
def distort_image_with_autoaugment(image, bboxes, augmentation_name):
    ...
    Args:
        ...
        augmentation_name: The name of the AutoAugment policy to use. The available
            ...
            on the COCO datasets. `v1`, `v2` and `v3` are additional good policies
            found on the COCO datasets that have slight variation in what operations
