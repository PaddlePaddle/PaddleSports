...
class Trainer(object):
    def __init__(self, cfg, mode='train'):
        ...
        # build model
        assert cfg['architecture'] in ['MaskRCNN'],'architecture {} not available!'.format(cfg['architecture'])
        if cfg['architecture'] == 'MaskRCNN':
            _architectures = getattr(architectures, 'MaskRCNN', None)
