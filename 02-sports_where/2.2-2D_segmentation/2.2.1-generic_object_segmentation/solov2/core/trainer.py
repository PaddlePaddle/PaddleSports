...
class Trainer(object):
    def __init__(self, cfg, mode='train'):
        ...
        # build model
        assert cfg['architecture'] in ['SOLOv2'],'architecture {} not available!'.format(cfg['architecture'])
        if cfg['architecture'] == 'SOLOv2':
            _architectures = getattr(architectures, 'SOLOv2', None)
    ...
    def predict(self,
                ...
                output_dir='output',
                save_results=False):
        self.dataset = SniperCOCODataSet(**self.cfg['TestDataset']['ImageFolder'])
